...
if ($result_email && mysqli_num_rows($result_email) > 0) {
    ...
    if (move_uploaded_file($_FILES['cv']['tmp_name'], $cv_path)) {
        ...
        $sql_insert = "INSERT INTO candidature (Numoffre, Numentrep, Nom, prenom, Nom_offre, adresse, Email, tel, diplome, cv, lettremotivation, datecandidature) 
        ...
        if (mysqli_query($connect, $sql_insert)) {
            ...
            try {
                ...
                $mail->setFrom('fatouma873@gmail.com', 'Site demande emploi');
